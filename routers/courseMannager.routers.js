...
const { getListCourses, getDetailCourse, createCourse, deleteCourse, updateCourse } = require('../controllers/courseMangager.controllers')
...
courseMannagerRouter.delete('/:id', logFeature('xoa khoa hoc'), authenticate, authorize(['admin']), checkExist(Courses), deleteCourse)
courseMannagerRouter.put('/:id', logFeature('cap nhat thong tin khoa hoc'), authenticate, authorize(['admin']), checkExist(Courses), updateCourse)
